...
<body> 
 ...
 <nav class="navbar">
     <img src="c:\Users\PC\Downloads\HOME.png" id="logo" onclick="hideAllContent()">
...
<section id="read" class="content"> 
 ...
 <table>
        <thead>
               <tr><th>ID</th><th>Surname</th><th>Name</th><th>midllename</th><th>Address</th><th>Contact</th></tr>
         </thead>
         <tbody> 
            <?php
            ...
            <table>
                  ...
                  <div style="display: flex; gap: 10px; margin-top: 10px;">
                      <form method="POST" style="margin: 0;">
                       ...
                       <button type="submit" name="btn_delete" class="btns" style="background-color: #9bd63b; color: white; border: none;">Delete Student</button>
                   </form>
                  </div>
              </div>
         <?php else: echo "<p style='color:red; margin-top:20px;'>Student ID not found.</p>"; endif; 
